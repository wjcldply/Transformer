...
Terminal Command: python json_preprocess.py source_language_file_dir target_language_file_dir output_file_dir
"""
...
def create_json(source_language_file, target_language_file, output_json_file):
...
# Test Runs
# create_json("datasets/iwslt17.de.en/train.de-en.de", "datasets/iwslt17.de.en/train.de-en.en", "datasets/iwslt17.de.en/train.json")
# create_json("datasets/iwslt17.de.en/valid.de-en.de", "datasets/iwslt17.de.en/valid.de-en.en", "datasets/iwslt17.de.en/valid.json")


if __name__ == "__main__":
    if len(sys.argv) != 4:
        print("Usage: python json_preprocess.py <src_lang_file> <tgt_lang_file> <output_file>")
        sys.exit(1)
    ...
    create_json(src_lang_file, tgt__lang_file, output_file)